...
(defn collection
  [name]
  (str "com.etzhayyim.kizashi." name))

(def cell-specs {
  :scan_session {:legacy-cell "scan-session"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "scan_session")]
     :required-gates common-gates
     :trigger "manifest cell scan_session"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :signal_fusion {:legacy-cell "signal-fusion"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "signal_fusion")]
     :required-gates common-gates
     :trigger "manifest cell signal_fusion"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :attribution {:legacy-cell "attribution"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "attribution")]
     :required-gates common-gates
     :trigger "manifest cell attribution"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :wellbecoming_track {:legacy-cell "wellbecoming-track"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "wellbecoming_track")]
     :required-gates common-gates
     :trigger "manifest cell wellbecoming_track"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :triage_referral {:legacy-cell "triage-referral"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "triage_referral")]
     :required-gates common-gates
     :trigger "manifest cell triage_referral"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :modality_registry {:legacy-cell "modality-registry"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "modality_registry")]
     :required-gates common-gates
     :trigger "manifest cell modality_registry"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
